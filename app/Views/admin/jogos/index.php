                ...
                <?php foreach ($jogos as $j): ?>
                    <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                        ...
                        <td class="py-4 px-4 text-center space-x-2">
                            ...
                            <button onclick="confirm('Excluir este jogo? (mock)')" class="bg-red-500/10 hover:bg-red-500/20 text-red-400 hover:text-red-300 border border-red-500/20 px-3 py-1 rounded-lg text-xs font-semibold uppercase tracking-wider transition-colors">
                                Excluir
                            </button>
                        </td>
                    </tr>
