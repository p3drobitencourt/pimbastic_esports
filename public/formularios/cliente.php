...
<head>
    ...
    <title>Novo Cliente - Pimbastic Esports</title>
...
<body>
    <main class="container">
        <div class="panel">
            ...
            <h1>Novo Cliente</h1>
            <p class="subtitle">Cadastre um novo cliente e sua carteira inicial</p>
            ...
            <form method="post" class="form-grid">
                ...
                <div>
                    ...
                    <input id="saldo_carteira" name="saldo_carteira" type="number" step="0.01" min="0" value="0">
                </div>
