...
<head>
    ...
    <title>Novo Campeonato - Pimbastic Esports</title>
...
<body>
    <main class="container">
        <div class="panel">
            ...
            <p class="subtitle">Cadastre um novo campeonato para organizar os jogos</p>
            ...
            <form method="post" class="form-grid">
                <input type="hidden" name="form_type" value="campeonato">
